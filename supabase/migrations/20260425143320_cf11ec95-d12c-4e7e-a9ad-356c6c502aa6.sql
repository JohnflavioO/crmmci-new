-- Atualizar a função RPC para filtrar por role e remover Abnolia
...
-- Ocultar Abnolia Azevedo das listagens comerciais
UPDATE public.profiles 
SET commercial_visible = false 
WHERE full_name ILIKE '%Abnolia%';