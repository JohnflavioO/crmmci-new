-- Cópia de drizzle/migrations/0000_secure_complete_backup_v2.sql (criada pelo Lovable fora de supabase/migrations).
-- Tabela de auditoria e funções usadas pela edge function backup-export.
