          ...
          <div className="space-y-4">
            <div className="rounded-xl border bg-card p-4 shadow-sm">
              ...
              <div className="space-y-2.5 text-sm">
                ...
                {selectedQuote.payment_terms && <div className="flex justify-between"><span className="text-muted-foreground">Pagamento</span><span className="font-medium">{selectedQuote.payment_terms}</span></div>}
